...
export default function ConfirmThankyou() {
      ...
      {Object.keys(eventDetails).length !== 0 && (
        <div className="wrapper full-width ">
          ...
          <div className="form_details">
            ...
            <p>
              {" "}
              <strong>تم حجز مقعدك</strong>
            </p>

            <p>
              شكراً لتأكيدك حضورك. نتطلع لرؤيتك في الندوة التي ستنعقد يوم{" "}
              {eventDetails?.events[0]?.time_date}
            </p>

            <a onClick={handleTicketDetails} className="btn btn-blue">
              تفاصيل التذكرة
            </a>
          </div>
        </div>
