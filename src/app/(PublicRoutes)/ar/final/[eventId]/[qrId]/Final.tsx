    ...
    <>
      <div className="wrapper full-width ">
        ...
        <div className="form_details ">
          ...
          <p className="title full-width navy_color mb-20 tpm text-center mt-10">
            شكرًا لك
          </p>

          <p className="title navy_color full-width tpm text-center mb-50">
            سيتم اعلامك بالندوات والمحاضرات المستقبلية التي قد تكون ضمن
            اهتماماتك
          </p>
          <p className="title navy_color info full-width tpm text-center  mt-20">
            <b>للمزيد من المعلومات يمكنك زيارة موقعنا الالكتروني </b>
            <a
              href="https://atfxmena.com/ar"
              target="_blank"
