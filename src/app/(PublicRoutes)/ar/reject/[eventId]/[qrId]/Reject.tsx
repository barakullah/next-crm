...
export default function Reject() {
  ...
  const handleTicketDetails = () => {
    history.push(`/ar/ticket/${param.eventId}/${param.qrId}/`);
  };
  return (
    <>
      <div className="wrapper full-width ">
        ...
        <div className="form_text_details">
          <div className="form_details">
            ...
            <p className="title d-block">نأسف لعدم تمكنك من الحضور</p>

            <p>
              <b>
                هل لديك اهتمام بالمشاركة في
                <span className="navy_color"> ندوات قادمة؟</span>
              </b>
            </p>
            <p>
              <a
                onClick={() =>
                  history.push(`/ar/final/${param.eventId}/${param.qrId}`)
                }
            ...
            <p>
              <a
                onClick={() =>
                  history.push(`/ar/done/${param.eventId}/${param.qrId}`)
                }
