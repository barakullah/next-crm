            ...
            <div className="form_text_details">
              <div className="full-width mt-0">
                <div className="text-center">
                  ...
                  <p>
                    for registering to attend {eventDetails?.events[0]?.name} at
                    {eventDetails?.events[0]?.time_date} We're excited to have
                    you join us!
                  </p>
                  <p>
                    <strong className="navyColor">
                      Add this to the calendar to receive a reminder with the
                      event details closer to the event date.
                    </strong>
                  </p>
